              ...
              {deviceList.map((device, i) => {
                ...
                return (
                  <tr key={i} style={{ borderBottom: '1px solid var(--border)' }}>
                    <td style={{ padding: '12px 12px 12px 0', fontFamily: 'var(--font-mono)', fontSize: 12, color: 'var(--blue)' }}>{device.ip}</td>
                    <td style={{ padding: '12px 12px 12px 0', fontFamily: 'var(--font-mono)', fontSize: 11, color: 'var(--muted)' }}>{device.mac || '—'}</td>
